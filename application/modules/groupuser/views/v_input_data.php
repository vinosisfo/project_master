...
<form id="form_data" autocomplete="off">
        ...
        <table class="customers" style="table-layout:auto;">
            <thead>
                <tr>
                    ...
                    <td>:</td>
                    <td>
                        <input type="text" name="nama_group" id="nama_group" maxlength="200" style="width : 98%;">
                    </td>
                </tr>
            </thead>
        </table>
            ...
            <table class="customers_border">
                ...
                foreach ($menu->result() as $data) {
                    ...
                    <tr>
                        <td><?php echo $no ?></td>
                        <td>
                            <input type="checkbox" name="cek_menu[]" id="cek_menu_<?php echo $no ?>" onclick="set_pilih('<?php echo $no ?>')">
                            <input type="hidden" name="status_cek[]" id="status_cek_<?php echo $no ?>" readonly>
    ...
    <div>
        <button class="btn btn-primary btn-xs" id="btn_simpan" type="button" onclick="cek_data_group(this)">Simpan</button>
