<div class="table-responsive">
  ...
  <table class="customers" style="table-layout : auto;white-space:nowrap;">
    <tr>
      ...
      <td>:</td>
      <td>
        <input type="text" name="departemen_src" id="nama_src">
      </td>

      <td>Bagian</td>
      <td>:</td>
      <td>
        <input type="text" name="singkatan_src" id="singkatan_src">
      </td>
...
<script type="text/javascript">
    ...
    function input_data(){
      $.post("<?php echo base_url('bagian/c_bagian/input_data')?>",{inpt : "input"},function(data){
    ...
    function edit_data(kode){
      $.post("<?php echo base_url('bagian/c_bagian/edit_data')?>",{kode : kode},function(data){
        $("#modal-default").modal("show")
        $("#data_detail").html(data)
      })
    }
    ...
    table = $('#tb_data_list').DataTable({ 
      ...
      "order"       : [],
      "ajax"        : {
          "url" : "<?php echo base_url('bagian/c_bagian/get_data')?>",
          "type": "POST",
          "data": function ( data ) {
            data.nama_src         = $('#nama_src').val()
            data.singkatan_src    = $('#singkatan_src').val()
