...
<script type="text/javascript">
    ...
    function input_data(){
      $.post("<?php echo base_url('departemen/c_departemen/input_data')?>",{inpt : "input"},function(data){
    ...
    function edit_data(kode){
      $.post("<?php echo base_url('departemen/c_departemen/edit_data')?>",{kode : kode},function(data){
        $("#modal-default").modal("show")
        $("#data_detail").html(data)
      })
    }
    ...
    table = $('#tb_data_list').DataTable({ 
      ...
      "order"       : [],
      "ajax"        : {
          "url" : "<?php echo base_url('departemen/c_departemen/get_data')?>",
          "type": "POST",
          "data": function ( data ) {
