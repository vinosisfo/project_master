...
<script>
  function add_data()
  {
    $.post("<?php echo base_url('group_user/c_group_user/get_form_input')?>",{"format" : "input"}, function(data){
      $(".judul").html("Input Group User");
      $("#form_data").html(data);
      $("#modal_master").modal("show");
    }) 
  }

  function edit_data(idgroup)
  {
    $.post("<?php echo base_url('group_user/c_group_user/get_form_edit')?>",{idgroup : idgroup}, function(data){
      $(".judul").html("Edit Group User");
      $("#form_data").html(data);
      $("#modal_master").modal("show");
    }) 
  }
  ...
  table = $('#tb_data_list').DataTable({ 
    ...
    "order"       : [],
    "ajax"        : {
      "url" : "<?php echo base_url('group_user/c_group_user/get_data')?>",
      "type": "POST",
      "data": function ( data ) {
